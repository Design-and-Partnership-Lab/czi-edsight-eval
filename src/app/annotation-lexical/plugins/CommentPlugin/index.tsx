...
function CommentInputBox({
    ...
    return (
        ...
        >
            <PlainTextEditor
                className="border-neutral-800 px-1 py-1 text-neutral-900"
                onEscape={onEscape}
                onChange={onChange}
            />
    ...
    return (
        <>
            ...
            <div className="Modal__content">
                <Button
                    className="!mr-2 !bg-[#4a6fa5] !text-neutral-100"
                    onClick={() => {
...
function CommentsPanelListComment({
    ...
    const seconds = Math.round(
        (comment.timeStamp - (performance.timeOrigin + performance.now())) /
            1000
    );
...
function CommentsPanel({
    ...
    return (
        <div className="CommentPlugin_CommentsPanel">
            <div className="CommentPlugin_CommentsPanel_Heading flex w-full items-center justify-between">
                <h2>Comments</h2>
                <span>
                    <XIcon />
                </span>
