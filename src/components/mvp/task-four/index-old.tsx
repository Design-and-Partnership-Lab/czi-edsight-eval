...
const aligned = [
    {
        ai: "“I can see that the student clearly mentioned that opportunities where they could improve on this assignment in the future.”",
        user: "“The student mentioned identifying areas for improvement such as ‘creating an outline first and using more color.’”",
    },
    {
        ai: "“I can see that the student clearly mentioned that opportunities where they could improve on this assignment in the future.”",
        user: "“The student mentioned identifying areas for improvement such as ‘creating an outline first and using more color.’”",
